...
<style lang="scss" scoped>
  ...
  .gray.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 1) inset, 1px 0 1px rgba(0, 0, 0, 0.2);
  ...
  .black.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 0.5) inset, 1px 0 1px rgba(0, 0, 0, 0.9);
  ...
  .red.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 0.6) inset, 1px 0 1px rgba(130, 25, 25, 0.9);
  ...
  .yellow.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 0.8) inset, 1px 0 1px rgba(148, 131, 4, 0.9);
  ...
  .green.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 0.8) inset, 1px 0 1px rgba(51, 126, 66, 0.9);
  ...
  .blue.round:after {
    box-shadow: 1px 0 1px rgba(255, 255, 255, 0.8) inset, 1px 0 1px rgba(18, 85, 128, 0.9);
