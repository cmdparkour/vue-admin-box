import{_ as n,d as o,r as h,o as s,c as a,a as r,b as F,w as p,f as c}from"./index.13b91343.js";const D=o({setup(){return{print:()=>{let d=`
        <html>
          <head>
            <title></title>
            <style>
      ...
      `,t=window.open("","\u8BA2\u5355\u8BE6\u60C5","toolbar=no,scrollbars=yes,menubar=no");t.document.body.innerHTML=d+i+e,t.print(),console.log(123),t.close()}}}}),b={class:"layout-container"},v={style:{"text-align":"left",padding:"15px"}},y=c("\u6253\u5370");function E(u,d,e,i,t,B){const l=h("el-button");return s(),a("div",b,[r("div",v,[F(l,{onClick:u.print},{default:p(()=>[y]),_:1},8,["onClick"])])])}var x=n(D,[["render",E]]);export{x as default};
